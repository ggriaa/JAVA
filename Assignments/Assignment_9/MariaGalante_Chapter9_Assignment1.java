/**
 * MariaGalante_Chapter9_Assignment1.java
 * COP 2250 -- Chapter 9, Assignment 1
 */

// ============================================================
// Rectangle_MG class -- NO public keyword on this class
// ============================================================
class Rectangle_MG {
    ...
    Rectangle_MG(double width, double height) {
        this.width = width;
        this.height = height;
    }
...
// ============================================================
public class MariaGalante_Chapter9_Assignment1 {

    public static void main(String[] args) {

        // STEP 6: Create rectangle 1 with width=4 and height=40

        Rectangle_MG r1 = new Rectangle_MG(4, 40);
        ...
        Rectangle_MG r2 = new Rectangle_MG(3.5, 35.9);
